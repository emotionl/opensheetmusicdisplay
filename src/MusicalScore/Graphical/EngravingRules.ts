...
export class EngravingRules {
    ...
    public resetChordSymbolLabelTexts(chordtexts: Dictionary<ChordSymbolEnum, string>): Dictionary<ChordSymbolEnum, string> {
        chordtexts.setValue(ChordSymbolEnum.minor, "−");
        chordtexts.setValue(ChordSymbolEnum.augmented, "+");
        chordtexts.setValue(ChordSymbolEnum.diminished, "o");
        chordtexts.setValue(ChordSymbolEnum.dominant, "7");
        chordtexts.setValue(ChordSymbolEnum.majorseventh, "Δ7");
        chordtexts.setValue(ChordSymbolEnum.minorseventh, "−7");
        chordtexts.setValue(ChordSymbolEnum.diminishedseventh, "o7");
        chordtexts.setValue(ChordSymbolEnum.augmentedseventh, "+7");
        chordtexts.setValue(ChordSymbolEnum.halfdiminished, "ø");
        chordtexts.setValue(ChordSymbolEnum.majorminor, "m(maj)");
        chordtexts.setValue(ChordSymbolEnum.majorsixth, "Δ6");
        chordtexts.setValue(ChordSymbolEnum.minorsixth, "−6");
        chordtexts.setValue(ChordSymbolEnum.dominantninth, "9");
        chordtexts.setValue(ChordSymbolEnum.majorninth, "Δ9");
        chordtexts.setValue(ChordSymbolEnum.minorninth, "−9");
        chordtexts.setValue(ChordSymbolEnum.dominant11th, "11");
        chordtexts.setValue(ChordSymbolEnum.major11th, "Δ11");
        chordtexts.setValue(ChordSymbolEnum.minor11th, "−11");
        chordtexts.setValue(ChordSymbolEnum.dominant13th, "13");
        chordtexts.setValue(ChordSymbolEnum.major13th, "Δ13");
        chordtexts.setValue(ChordSymbolEnum.minor13th, "−13");
